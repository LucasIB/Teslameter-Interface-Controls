...
#Configuracao Serial Agilent 34401 - Campo Senis
...
#Configuracao Serial Agilent 34401 - Temperatura Senis
serAg3 = serial.Serial(6)
serAg3.baudrate = 9600
serAg3.bytesize = serial.EIGHTBITS
serAg3.stopbits = serial.STOPBITS_ONE
serAg3.parity = serial.PARITY_NONE
serAg3.timeout = .063
##serAg3.timeout = .362
#ser.writeTimeout = 0
if not serAg3.isOpen():
    serAg3.open()
...
##        c.writerow([Datahora,temp,campo,corrente])
##        EscreverResultados()
        print (i+1)
    print ('Concluído!')
